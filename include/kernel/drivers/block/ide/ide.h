...
#define IDE_TIMEOUT     10000000 /* Nombre d'essai avant de conclure que le disque n'est pas prt */
...
u8                           /* Retour : code d'erreur */
    idepGetInf(
      ...
      u8                     /* Protocole �utiliser pour interroger le disque */
    );
